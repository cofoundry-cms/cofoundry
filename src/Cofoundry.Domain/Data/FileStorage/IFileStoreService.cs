...
namespace Cofoundry.Domain.Data
{
    ...
    public interface IFileStoreService
    {
        ...
        bool Exists(string containerName, string fileName);
        ...
        void DeleteDirectory(string containerName, string directoryName);
        ...
        /// <param name="containerName">The name of the container containing the directory to delete</param>
        /// <param name="directoryName">The name of the directory to delete</param>
        void ClearDirectory(string containerName, string directoryName);
