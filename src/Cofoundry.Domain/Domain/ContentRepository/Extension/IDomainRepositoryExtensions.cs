...
{
    extension(IDomainRepository domainRepository)
    {
        /// <summary>
        ...
        /// </summary>
        public IDomainRepositoryTransactionManager Transactions()
        {
        ...
        public IDomainRepositoryQueryContext<TResult> WithQuery<TResult>(IQuery<TResult> query)
        {
    ...
    extension<TRepository>(TRepository repository) where TRepository : IDomainRepository
    {
        ...
        /// </param>
        public TRepository WithContext(IExecutionContext executionContext)
        {
        ...
        /// </param>
        public TRepository WithContext(IUserContext userContext)
        {
        ...
        /// user prior to sign.
        /// </summary>
        public TRepository WithElevatedPermissions()
        {
            var extendedContentRepositry = repository.AsExtendableContentRepository();
            var executionContextFactory = extendedContentRepositry.ServiceProvider.GetRequiredService<IExecutionContextFactory>();
        ...
        /// </param>
        public TRepository WithRandomDuration(int minDurationInMilliseconds, int maxDurationInMilliseconds)
        {
        ...
        /// </param>
        public TRepository WithRandomDuration(
    ...
    extension(IDomainRepository repository)
    {
        /// <summary>
        ...
        /// tasks with.
        /// </typeparam>
        public IDomainRepository WithContext<TUserAreaDefinition>()
        ...
        /// with existing data.
        /// </param>
        public async Task PatchCommandAsync<TCommand>(Action<TCommand> commandPatcher)
        ...
        /// with existing data.
        /// </param>
        public async Task PatchCommandAsync<TCommand>(int id, Action<TCommand> commandPatcher)
