...
namespace Cofoundry.Domain
{
    ...
    public interface IUserContextService
    {
        ...
        /// auth scheme, which is typically the default user area unless the ambient sceme 
        /// has been changed by during the flow of the request e.g. via an AuthorizeUserAreaAttribute
        /// </para>
        /// <para>
