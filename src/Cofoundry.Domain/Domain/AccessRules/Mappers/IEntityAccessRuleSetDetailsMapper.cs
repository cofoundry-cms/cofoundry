...
/// <summary>
/// Used for mapping the shared parts of an <see cref="IEntityAccessRuleSetDetails{TEntityAccessRuleSummary}"/>
/// implementation for a specific entity.
/// </summary>
public interface IEntityAccessRuleSetDetailsMapper
{
    /// <summary>
    /// Maps the shared parts of an <see cref="IEntityAccessRuleSetDetails{TEntityAccessRuleSummary}"/>
    /// implementation for a specific entity.
    /// </summary>
    ...
    /// <param name="result">
    /// The <see cref="IEntityAccessRuleSetDetails{TEntityAccessRuleSummary}"/> projection to map to. Typically the mapper
