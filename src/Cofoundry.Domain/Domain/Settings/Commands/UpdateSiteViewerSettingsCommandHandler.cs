...
namespace Cofoundry.Domain
{
    ...
    /// </remarks>
    public class UpdateSiteViewerSettingsCommandHandler 
        : IAsyncCommandHandler<UpdateSiteViewerSettingsCommand>
        , IIgnorePermissionCheckHandler
    {
        ...
        public UpdateSiteViewerSettingsCommandHandler(
        ...
        public async Task ExecuteAsync(UpdateSiteViewerSettingsCommand command, IExecutionContext executionContext)
        {
            ...
            _settingCommandHelper.SetSettingProperty(command, c => c.SiteViewerDeviceView, allSettings, executionContext);
