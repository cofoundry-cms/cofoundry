...
/// <summary>
/// Extension methods for <see cref="IPasswordPolicyBuilder"/>.
/// </summary>
public static class IPasswordPolicyBuilderExtensions
{
    extension(IPasswordPolicyBuilder builder)
    {
        /// <summary>
        ...
        /// </param>
        public IPasswordPolicyBuilder UseDefaults()
        {
        ...
        public IPasswordPolicyBuilder AddAttribute(string attribute, int value)
        {
        ...
        /// characters.
        /// </param>
        public IPasswordPolicyBuilder ValidateMinLength(int minLength)
        {
            builder
        ...
        /// characters.
        /// </param>
        public IPasswordPolicyBuilder ValidateMaxLength(int maxLength)
        {
            builder
        ...
        /// </param>
        public IPasswordPolicyBuilder ValidateMinUniqueCharacters(int minUniqueCharacters)
        {
        ...
        /// Builder to add rules to.
        /// </param>
        public IPasswordPolicyBuilder ValidateNotPersonalData()
        {
        ...
        /// Builder to add rules to.
        /// </param>
        public IPasswordPolicyBuilder ValidateNotCurrentPassword()
        {
        ...
        /// Builder to add rules to.
        /// </param>
        public IPasswordPolicyBuilder ValidateNotSequential()
        {
