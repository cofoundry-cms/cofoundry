...
namespace Cofoundry.Domain
{
    ...
    /// rule configuration. 
    /// </summary>
    public class IsPageAccessRuleUniqueQuery : IQuery<bool>, IValidatableObject
    {
        /// <summary>
        /// Id of a page access rule to exclude from the check. Used when 
        /// checking an existing rule for uniqueness.
        /// </summary>
        public int? PageAccessRuleId { get; set; }

        /// <summary>
        /// Id of the page that the uniqueness check should be scoped to.
        /// </summary>
        [Required]
        [PositiveInteger]
