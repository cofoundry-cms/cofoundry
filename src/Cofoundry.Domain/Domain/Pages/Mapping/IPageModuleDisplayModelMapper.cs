...
namespace Cofoundry.Domain
{
    ...
    {
        Task<IEnumerable<PageModuleDisplayModelMapperOutput>> MapAsync(IEnumerable<PageModuleDisplayModelMapperInput<TDataModel>> inputs, WorkFlowStatusQuery workflowStatus);
    }
}
