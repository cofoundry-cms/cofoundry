...
namespace Cofoundry.Domain
{
    ...
    /// </summary>
    public class AddPageAccessRuleCommand : ICommand, ILoggableCommand, IValidatableObject
    {
        /// <summary>
        /// Id of the page to add the rule to.
        /// </summary>
        [Required]
        [PositiveInteger]
        ...
        /// </summary>
        [OutputValue]
        public int OutputPageAccessRuleId { get; set; }
