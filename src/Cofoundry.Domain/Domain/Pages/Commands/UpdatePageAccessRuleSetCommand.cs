...
namespace Cofoundry.Domain
{
    ...
    /// </summary>
    public class UpdatePageAccessRuleSetCommand : UpdateAccessRuleSetCommandBase<UpdatePageAccessRuleSetCommand.AddOrUpdatePageAccessRuleCommand>, ILoggableCommand
    {
        /// <summary>
