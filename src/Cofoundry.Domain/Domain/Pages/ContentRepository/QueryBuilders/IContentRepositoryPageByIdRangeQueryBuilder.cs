...
namespace Cofoundry.Domain
{
    ...
    public interface IContentRepositoryPageByIdRangeQueryBuilder
    {
        ...
        Task<IDictionary<int, PageRenderSummary>> AsRenderSummariesAsync(PublishStatusQuery? publishStatus = null);
        ...
        /// </summary>
        /// <param name="publishStatus">Used to determine which version of the page to include data for.</param>
        Task<IDictionary<int, PageRenderDetails>> AsRenderDetailsAsync(PublishStatusQuery? publishStatus = null);
    }
}
