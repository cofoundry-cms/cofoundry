...
public class HtmlAttribute : Attribute, IMetadataAttribute
{
    ...
    /// </summary>
    public IReadOnlyCollection<HtmlToolbarPreset> Toolbars { get; } = Array.Empty<HtmlToolbarPreset>();

    /// <summary>
    /// When using <see cref="HtmlToolbarPreset.Custom"/>, use this to secify which buttons to include in
    ...
    /// from <see cref="IHtmlEditorConfigSource"/>, which provides a .NET 
    /// code generated set of options.
    /// </summary>
