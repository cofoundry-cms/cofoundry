...
namespace Cofoundry.Domain
{
    ...
    /// </summary>
    public class GetRewriteRuleByPathQueryHandler 
        : IQueryHandler<GetRewriteRuleByPathQuery, RewriteRuleSummary>
        , IAsyncQueryHandler<GetRewriteRuleByPathQuery, RewriteRuleSummary>
        , IPermissionRestrictedQueryHandler<GetRewriteRuleByPathQuery, RewriteRuleSummary>
    {
        #region constructor
        ...
        public GetRewriteRuleByPathQueryHandler(
        ...
        private RewriteRuleSummary FindRule(GetRewriteRuleByPathQuery query, IEnumerable<RewriteRuleSummary> rules)
        {
        ...
        public IEnumerable<IPermissionApplication> GetPermissions(GetRewriteRuleByPathQuery command)
        {
