...
namespace Cofoundry.Domain
{
    public static class IPermissionCollectionExtensions
    {
        ...
        /// <param name="permissionsToFilter">The collection of permissions to filter</param>
        /// <returns>Filtered collection of permissions</returns>
        public static IEnumerable<IPermission> FilterByType<TPermission>(this IEnumerable<IPermission> permissionsToFilter)
        {
        ...
        {
            return permissionsToFilter
                .Where(p => _writePermissionTypeCodes.Contains(p.PermissionType.Code));
        }
