...
{
    /// <summary>
    /// Used construct mail templates for Cofoundry admin panel users when 
    /// sending email notifications for actions such as creating new users 
    /// and resetting password etc.
    /// </summary>
    public interface ICofoundryAdminMailTemplateBuilder
    {
        ...
        /// and the temporary password.
        /// </param>
        Task<AdminPasswordResetMailTemplate> BuildPasswordResetTemplateAsync(PasswordResetTemplateBuilderContext context);
        ...
        /// </param>
        Task<AdminAccountRecoveryMailTemplate> BuildAccountRecoveryTemplateAsync(AccountRecoveryTemplateBuilderContext context);
