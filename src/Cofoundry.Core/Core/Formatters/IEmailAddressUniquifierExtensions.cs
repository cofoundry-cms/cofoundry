...
/// <summary>
/// Extension methods for <see cref="IEmailAddressUniquifier"/>.
/// </summary>
public static class IEmailAddressUniquifierExtensions
{
    extension(IEmailAddressUniquifier uniquifier)
    {
        /// <summary>
        /// <para>
        ...
        /// </param>
        public string? Uniquify(string? emailAddress)
        {
            return uniquifier
        ...
        /// then <see langword="null"/> is returned.
        /// </param>
        public string? Uniquify(NormalizedEmailAddress? emailAddressParts)
        {
            return uniquifier
