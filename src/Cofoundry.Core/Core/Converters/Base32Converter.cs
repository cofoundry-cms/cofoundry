...
// Original source: https://github.com/dotnet/aspnetcore/blob/v8.0.0/src/Identity/Extensions.Core/src/Base32.cs
...
/// <summary>
/// A base32 implementation copied from Microsoft.AspNetCore.Identity.Base32.
/// </summary>
/// <remarks>
/// This is pubternal because the implementation is copied from internal code and
/// isn't directly required as a public API.
/// </remarks>
public static class Base32Converter
{
    ...
    /// <summary>
    /// Referenced by Cofoundry.Domain.SecurityStampGenerator to mirror the behavior
    /// of ASP.NET UserManager.NewSecurityStamp when generating a random base32 string. 
    /// I've kept it here to keep parity with the source, however this doesn't seem like 
    /// the best place to have it. However this uses a fixed length of 20 in .NET 8 which seems an odd choice for
    /// a shared function, so perhaps something to be aware of.
    /// </summary>
