...
namespace Cofoundry.Core.EntityFramework
{
    ...
    public interface IEntityFrameworkSqlExecutor
    {
        ...
        /// </returns>
        T[] ExecuteQuery<T>(DbContext dbContext, string spName, params SqlParameter[] sqlParams)
            where T : class;
        ...
        /// </returns>
        object ExecuteCommand(DbContext dbContext, string spName, params SqlParameter[] sqlParams);
        ...
        /// </returns>
        T ExecuteCommandWithOutput<T>(DbContext dbContext, string spName, string outputParameterName, params SqlParameter[] sqlParams);
