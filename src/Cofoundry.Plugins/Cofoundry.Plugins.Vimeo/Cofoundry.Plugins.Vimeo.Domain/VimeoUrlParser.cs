...
public static partial class VimeoUrlParser
{
    ...
    public static string GetId(string vimeoVideoUrl)
    {
    ...
    [GeneratedRegex(@"^.*(vimeo\.com\/)((channels\/[A-z]+\/)|(groups\/[A-z]+\/videos\/))?([0-9]+)", RegexOptions.IgnoreCase | RegexOptions.Multiline | RegexOptions.CultureInvariant)]
