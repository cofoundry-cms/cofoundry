...
var StringUtility = (function () {
     ...
     */
    StringUtility.prototype.getFileNameWithoutExtension = function (path) {
        if (!path)
            return path;
     ...
     */
    StringUtility.prototype.capitaliseFirstLetter = function (s) {
        if (!s)
            return s;
     ...
     */
    StringUtility.prototype.lowerCaseFirstLetter = function (s) {
        if (!s)
            return s;
     ...
     */
    StringUtility.prototype.endsWith = function (s, suffix) {
        return s.indexOf(suffix, s.length - suffix.length) !== -1;
    };
    /**
     * Checks if a string starts with the specified value. Case sensitive.
     */
    StringUtility.prototype.startsWith = function (s, prefix) {
     ...
     */
    StringUtility.prototype.slugify = function (s) {
        if (!s)
            return s;
        var result = this.latinise(s)
            .replace(' & ', ' and ')
            .replace(/[^\w\s-]/g, '')
            .toLowerCase()
            .trim()
     ...
     */
    StringUtility.prototype.toSnakeCase = function (s) {
        if (!s)
            return '';
     ...
     */
    StringUtility.prototype.toQueryString = function (obj) {
        return _.chain(obj)
            .sortBy(function (kvp) {
            return kvp[0];
        })
     ...
     */
    StringUtility.prototype.latinise = function (s) {
        if (!s)
            return s;
        var result = s.replace(/[^A-Za-z0-9\[\] ]/g, function (x) { return this.LATIN_MAP[x] || x; });
        return result;
    };
    StringUtility.prototype.format = function (s) {
    ...
    StringUtility.prototype.stripTags = function (s) {
        if (!s)
            return s;
        return s.replace(/<([^>]+)>/ig, "");
    };
