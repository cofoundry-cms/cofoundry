...
/// </summary>
public class AuthorCustomEntityDefinition
    : ICustomEntityDefinition<AuthorDataModel>
    , ICustomizedTermCustomEntityDefinition
{
    ...
    /// </summary>
    public const string DefinitionCode = "SIMAUT";
    ...
    /// </summary>
    public string NamePlural => "Authors";

    /// <summary>
    /// A short description that shows up as a tooltip for the admin 
    /// module.
    /// </summary>
    public string Description => "An author for one or more blog posts.";
