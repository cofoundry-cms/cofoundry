...
/// <summary>
/// Extensions to cut down on boilerplate when working with <see cref="WebApplicationFactory{TEntryPoint}"/>
/// </summary>
public static class WebApplicationFactoryExtensions
{
    extension<TEntryPoint>(WebApplicationFactory<TEntryPoint> factory) where TEntryPoint : class
    {
        /// <summary>
        ...
        public WebApplicationFactory<TEntryPoint> WithServices(Action<IServiceCollection> serviceConfiguration)
        {
        ...
        /// </summary>
        /// <param name="serviceConfiguration">Service configuration delegate to run after all other services have been resgistered.</param>
        public HttpClient CreateClientWithServices(Action<IServiceCollection> serviceConfiguration)
        {
        ...
        /// </param>
        public HttpClient CreateClient(Action<WebApplicationFactoryClientOptions>? configureClientOptions)
        {
        ...
        /// </para>
        /// </summary>
        public IntegrationTestApplication CreateApp()
        {
