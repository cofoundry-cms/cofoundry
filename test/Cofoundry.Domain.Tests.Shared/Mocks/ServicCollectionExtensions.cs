...
public static class ServicCollectionExtensions
{
    extension(IServiceCollection serviceCollection)
    {
        ...
        public IServiceCollection MockHandler<TCommand>(Action<TCommand> handlerDelegate)
        ...
        public IServiceCollection MockHandler<TCommand>(Func<TCommand, Task> asyncHandlerDelegate)
            where TCommand : ICommand
        {
        ...
        public IServiceCollection MockHandler<TQuery, TResult>(TResult result)
        ...
        public IServiceCollection MockHandler<TQuery, TResult>(Func<TQuery, TResult> queryDelegate)
            where TQuery : IQuery<TResult>
        {
        ...
        public IServiceCollection MockHandler<TQuery, TResult>(Func<TQuery, Task<TResult>> asyncQueryDelegate)
            where TQuery : IQuery<TResult>
        {
        ...
        /// </summary>
        public IServiceCollection TurnOnDeveloperExceptionPage()
        {
