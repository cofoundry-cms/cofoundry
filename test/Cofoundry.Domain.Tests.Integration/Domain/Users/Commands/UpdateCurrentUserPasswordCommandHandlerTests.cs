...
namespace Cofoundry.Domain.Tests.Integration
{
    ...
    public class UpdateCurrentUserPasswordCommandHandlerTests
    {
            ...
            using (var scope = _dbDependentFixture.CreateServiceScope())
            {
                ...
                if (result != null)
                {
                    user = await dbContext
                        .Users
                        .AsNoTracking()
                        .SingleOrDefaultAsync(u => u.UserId == result.UserId);
                }
            }
        ...
        [Fact]
        public async Task WhenInvalidExistingPassword_ThrowsValidationException()
        {
            ...
            using (var scope = _dbDependentFixture.CreateServiceScope())
            {
                ...
                await Assert.ThrowsAsync<ValidationErrorException>(
