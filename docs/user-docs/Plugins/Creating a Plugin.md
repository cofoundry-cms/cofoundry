...
*We plan to document this area more fully in the future, but to get a flavor of how this all works, take a look at the source code for existing plugins such as [Mail.SendGrid](https://www.nuget.org/packages/Cofoundry.Plugins.Mail.SendGrid), [Azure](https://www.nuget.org/packages/Cofoundry.Plugins.Azure) and [ErrorLogging](https://www.nuget.org/packages/Cofoundry.Plugins.ErrorLogging)*