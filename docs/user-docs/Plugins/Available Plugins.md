...
### [Cofoundry.Plugins.Azure](https://www.nuget.org/packages/Cofoundry.Plugins.Azure)

This library contains services, abstractions and helpers for running in an Azure environment.

### [Cofoundry.Plugins.BackgroundTasks.Hangfire](https://www.nuget.org/packages/Cofoundry.Plugins.BackgroundTasks.Hangfire)

Hangfire implementation of Cofoundry.Core.BackgroundTasks. 

### [Cofoundry.Plugins.ErrorLogging](https://www.nuget.org/packages/Cofoundry.Plugins.ErrorLogging)
...
###  [Cofoundry.Plugins.Imaging.ImageSharp](https://www.nuget.org/packages/Cofoundry.Plugins.Imaging.ImageSharp)
...
###  [Cofoundry.Plugins.Imaging.SkiaSharp](https://www.nuget.org/packages/Cofoundry.Plugins.Imaging.SkiaSharp)
...
### [Cofoundry.Plugins.Mail.MailKit](https://www.nuget.org/packages/Cofoundry.Plugins.Mail.MailKit)

Cofoundry mail services that utilize the cross platform MailKit library. 

### [Cofoundry.Plugins.Mail.SendGrid](https://www.nuget.org/packages/Cofoundry.Plugins.Mail.SendGrid)

Cofoundry mail service implemention for SendGrid.

### [Cofoundry.Plugins.SiteMap](https://www.nuget.org/packages/Cofoundry.Plugins.SiteMap)
...
### [Cofoundry.Plugins.Vimeo](https://www.nuget.org/packages/Cofoundry.Plugins.Vimeo)
...
### [Cofoundry.Plugins.YouTube](https://www.nuget.org/packages/Cofoundry.Plugins.YouTube)
